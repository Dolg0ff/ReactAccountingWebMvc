...
namespace ReactAccountingWebMvc.Domain.Migrations
{
    public partial class mg1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TwoModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TwoModels_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TwoModels_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TwoModels_AccountId",
                table: "TwoModels",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_TwoModels_TransactionId",
                table: "TwoModels",
